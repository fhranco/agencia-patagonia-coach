...
const PhoneButton = () => {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-24 right-8 z-50 w-12 h-12 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center border border-white/20 group transition-all hover:bg-patagonia-cyan shadow-xl"
    >
      <Phone className="w-5 h-5 text-white/70 group-hover:text-patagonia-void" />
